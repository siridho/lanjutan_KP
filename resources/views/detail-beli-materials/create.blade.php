        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Create New DetailBeliMaterial</div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => '/detail-beli-materials', 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('detail-beli-materials.form')
