            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <input type="hidden" id="urut" value='0'>
                        ...
                        @endif
                         {!! Form::open(['url' => '/opname_volume_pekerjaans', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true]) !!}
                                {{csrf_field()}}
                                <table width="100%">
                                    <tr height="50px">
                                      ...
                                      <table class="table">
                                        ...
                                        <tr id='no1'>
                                                <td width='15%'>
                                                    ...
                                                    <select class="kode form-control" name='kode[]' id='kode1' onchange='setsatuan(this)'>
                                                ...
                                                <td width='25%'><input type='number' min='0' step='any' required name='volume[]' id='volume1' class='form-control'></td>
                                                <td width='5%' id='satuan1'></td>
