        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Tambah Nota Pengeluaran Kas</div>
                                ...
                                <div class="table table-responsive">
                                      <table class="table">
                                        ...
                                        <tr id='no1'>
                                                ...
                                                <td width='10%'>
                                                    <input type='number' step='any' required name='qty[]' class='qty form-control' id='qty1' min='0' value='0' onkeyup='getTotal(1)' onchange='getTotal(1)'>
                                                </td>
                                                <td width='20%'><input type='number' step='any' required name='price[]' id='price1' class='form-control' onchange='getTotal(1)' onkeyup='getTotal(1)'></td>
                                                <td width='25%'><input type='number' required readonly name='total[]' id='total1' class='form-control'></td>
