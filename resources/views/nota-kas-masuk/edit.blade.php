        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Ubah Nota Kas Masuk</div>
                    ...
                    <input type="hidden" id="urut" value='0'>
                        ...
                        @endif
                         {!! Form::open(['url' => ['/nota-kas-masuk', $notakasmasuk->nonota ], 'method' => 'patch', 'class' => 'form-horizontal', 'files' => true]) !!}
                                {{csrf_field()}}
                                <table width="100%">
                                    <tr height="50px">
                                        <td width="100px" align="right" style="padding-right:10px;"> No Penerimaan Kas </td>
                                        <td width="200px"><input placeholder="Masukkan nomor nota" class="form-control" type="text" required readonly name="nonota2" value="{{substr($notakasmasuk->nonota,6)}}"></td>
                                        <input placeholder="Masukkan nomor nota" class="form-control" type="hidden" required readonly name="nonota" value="{{$notakasmasuk->nonota}}">
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td width="200px">
                                           <input class="form-control" type="text" name="cboreferensi" value="{{$notakasmasuk->referensi}}" placeholder="Masukkan Kode Referensi">
                                ...
                                <div class="table table-responsive">
                                      <table class="table">
                                        ...
                                        <tr id='no{{$itung}}'>
                                                <td width='60%'>
                                                    <textarea id='uraian{{$itung}}' name='uraian[]' class='uraian form-control' style='resize:none;'>{{$detail->uraian}}</textarea>
                                                </td>
                                                <td width='25%'><input type='number' step='any' required name='price[]' id='price{{$itung}}' class='form-control' value="{{$detail->saldo}}" onchange='getTotal(1)' onkeyup='getTotal(1)'></td>
