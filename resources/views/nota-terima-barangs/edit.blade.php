            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <input type="hidden" id="urut" value='0'>
                        ...
                        @endif
                         {!! Form::open(['url' => ['/nota-terima-barangs', $notaterimabarang->nonota], 'method' => 'PATCH', 'class' => 'form-horizontal', 'files' => true]) !!}
                                {{csrf_field()}}
                                ...
                                <table width="100%">
                                    <tr height="50px">
                                        ...
                                        <td width="200px"><input placeholder="Masukkan nomor nota" class="form-control" type="text" required readonly name="nonota" value="{{substr($notaterimabarang->nonota,6)}}"></td>
                                     ...
                                     @php
                                    $tgl=date_create($notaterimabarang->tglNota);
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td width="200px"><input type="text" name="referensi" class="form-control" value="{{$notaterimabarang->referensi}}" ></td>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td width="200px">
                                            ...
                                            @foreach($mitras as $mitra)
                                                @if($mitra->kodeMitra==$notaterimabarang->kodeMitra)
                                        ...
                                        <td width="200px">
                                            ...
                                            <option value="">--Pilih Nota Beli--</option>
                                                @foreach($notabeli as $nota)
                                                    @if($nota->nonota==$notaterimabarang->nonota_beli)
                                                    <option value="{{$nota->nonota}}" selected>({{$nota->nonota}}) {{$nota->tglNota}}</option>
                                                    @else
                                ...
                                <div class="table table-responsive">
                                      <table class="table">
                                        ...
                                        <td width='10%'><input type='hidden' name='barisbeli[]' value='{{$detail->baris_detail_beli}}'><input type='number' step='any' name='qty[]' class='qty form-control' id='qty{{$itung}}' min='0' value='{{$detail->jumlah}}' onchange='getTotal({{$itung}})' ></td><td width="5%">{{$detail->material->satuan}}</td>
