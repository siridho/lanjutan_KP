        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Tambah Nota Penggunaan Material</div>
                    ...
                    <input type="hidden" id="urut" value='0'>
                        ...
                        @endif
                         {!! Form::open(['url' => '/nota-penggunaan-materials', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true]) !!}
                                {{csrf_field()}}
                                <table width="100%">
                                    <tr height="50px">
                                        <td width="100px" align="right" style="padding-right:10px;"> No Nota </td>
                                        <td width="200px"><input placeholder="Masukkan nomor nota" class="form-control" type="text" required name="nonota" readonly value="{{substr($kode,6)}}"></td>
                                    ...
                                    <tr height="50px">
                                        ...
                                        <td width="200px">
                                            <input placeholder="Masukkan nomor referensi" class="form-control" name="cboreferensi">
                                        </td>
                                    </tr>
                                    <tr height="50px">
                                ...
                                <div class="table table-responsive">
                                      <table class="table">
                                        ...
                                        <input type="hidden" name="maxbar" id="maxbar" value="{{$jummaterial}}">
