        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit Detail_opname_pekerjaan #{{ $detail_opname_pekerjaan->id }}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::model($detail_opname_pekerjaan, [
                            'method' => 'PATCH',
                        ...
                        @include ('detail_opname_pekerjaans.form', ['submitButtonText' => 'Update'])
